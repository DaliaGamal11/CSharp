namespace ConsoleApp9
{
    ...
    using System.Xml.Linq;
        ...
        public enum SecurityLevel //guest, Developer, secretary and DBA.
    {
            Guest,          // Level 1
            Developer,      // Level 2
            Secretary,      // Level 3
        ...
        internal class Program
        {
            ...
            /* Employee[] employees = new Employee[3];
             ...
             for (int i = 0; i < 3; i++)
             {
                 ...
                 Console.Write("Enter Employee Security Level (Basic, Intermediate, Manager, Administrator, Executive): ");
            ...
            Console.WriteLine("the subtract : " + calc.sub(num1, num2));
            Console.WriteLine("the multiplication : " + calc.multiply(num1, num2));
            Console.WriteLine("the divistion  : " + calc.divide(num1, num2));

            Console.WriteLine("--------------------------------------------------------------------------");
            // part of sum , average for columns
            //enter values 
            int[,] ClassGrade = new int[3, 5]; 
            for (int i = 0; i < ClassGrade.GetLength(0); i++)
            {
                Console.WriteLine($"enter grades of the student {i+1}:");
                for (int j = 0; j < ClassGrade.GetLength(1); j++)
                {
                    Console.WriteLine($"enter grade {j+1}");
                    ClassGrade[i,j] =int.Parse(Console.ReadLine());
            ...
            for (int i = 0; i < ClassGrade.GetLength(0); i++)
            {
                ...
                for (int j = 0; j < ClassGrade.GetLength(1); j++)
                {
                    Console.WriteLine($"Grade {j + 1}: {ClassGrade[i, j]}");
                }
            }
            Console.WriteLine("--------------------------------------------------------------------------");
            //switch loops to get sum of columns
            for (int j = 0; j < ClassGrade.GetLength(1); j++)
            {
                ...
                avg = (double)Sum / ClassGrade.GetLength(0);
                Console.WriteLine($"Sum of column {j + 1}: {Sum}");
                Console.WriteLine($"avg of column {j + 1}: {avg}");
            }
